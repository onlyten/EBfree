...
var _idx=0,
	...
	history=[],
	baseThemeColors=['63b359','2c9f67','509fc9','5885cf','9062c0','d09a45','e4b138','ee903c','f08500','a9d92d','dd6549','cc463d','cf3e36','5E6671'],
...
$.widget( "evol.colorpicker", {
		...
		switch(this.element.get(0).tagName){
			case 'INPUT':
				...
				e.addClass('colorPicker '+this._id)
					.wrap('<div style="width:'+(this.options.hideButton?this.element.width():this.element.width()+38)+'px;'+
	...
	_paletteHTML: function() {
		...
		var h='<div class="evo-pop'+_ie+' ui-widget ui-widget-content ui-corner-all"'+
			(this._isPopup?' style="left:630px;position:absolute"':'')+'>'+
			// palette
	...
	_paletteHTML1: function() {
		...
		h+='</tr><tr><th colspan="10"></th></tr><tr>';
		for(var i=10;i<14;i++){ 
			h+=oTD+baseThemeColors[i]+cTD;
		}
		h+='</tr>';
