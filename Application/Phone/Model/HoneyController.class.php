...
class HoneyController extends Controller {
    public function honey(){
        ...
        cookie('start_num',count($mission_start),259200);
...
//查看卡券 王超 20160426
    ...
    public function dashang(){
    	if(I('get.serial_id')){//影院打赏
        	...
        	echo  "<script>alert('参数错误，请重试！');window.location.href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx7e4fb28fe1443248&redirect_uri=http://serv2.matesofts.com/huatong/index.php/Phone/Index/index&response_type=code&scope=snsapi_base&state=123#wechat_redirect'</script>";
    	}
    }
    public function dashang_update(){
   		$post = "http://serv2.matesofts.com/huatong/index.php/Phone/MsWxpay/js_api_cal?money=".I('post.money')."&member_id=".I('post.member_id')."&mission_id=".I('post.mission_id')."&serial_id=".I('post.serial_id');
    ...
    public function task_detail_update(){//我的任务
        ...
        if($answer[0]['success'] != ""){
			...
			echo  "<script>window.location.href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx7e4fb28fe1443248&redirect_uri=http://serv2.matesofts.com/huatong/index.php/Phone/Honey/honey&response_type=code&scope=snsapi_base&state=123#wechat_redirect'</script>";
   ...
   //          echo " $a  $b $c <br>";
    ...
    public function tixian_update(){ //红包提现更新
        ...
        if($money > $member['red_packet']){
            echo '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />';
            echo  "<script>alert('提现金额超过了您的红包余额！');window.location.href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx7e4fb28fe1443248&redirect_uri=http://serv2.matesofts.com/huatong/index.php/Phone/Index/index&response_type=code&scope=snsapi_base&state=123#wechat_redirect'</script>";
        }else{
            ...
            if($n->data($data)->add()){
                 echo '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />';
                echo  "<script>alert('申请提现成功，请耐心等待！');window.location.href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx7e4fb28fe1443248&redirect_uri=http://serv2.matesofts.com/huatong/index.php/Phone/Index/index&response_type=code&scope=snsapi_base&state=123#wechat_redirect'</script>";
            }
        }
    }
  ...
  /*我的班级 王超 20160412 test*/
    ...
    public function after_class_jump(){
        ...
        $teacher_info= array('name'=>'王老师','qrcode'=>"/huatong/Public/images/honey/teacher_qrcode/1675713710.jpg");
    ...
    public function advertise(){
        $img_url='/huatong/Public/images/AboutUs/advertise.png';
